...
- ViewLatexListener 监听事件，提供代码片段输入功能；
...
- on_query_completions 事件可以很好地通过提供自动完成内容来替代 code sippet 功能。例如，以下自动完成事件中，用户输入 matlab + TAB 就会触发相应的代码块。
